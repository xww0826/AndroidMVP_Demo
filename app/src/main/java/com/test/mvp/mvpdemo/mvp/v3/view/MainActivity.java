package com.test.mvp.mvpdemo.mvp.v3.view;
...
import com.test.mvp.mvpdemo.mvp.v3.basemvp.BaseActivity;
import com.test.mvp.mvpdemo.mvp.v3.presenter.MainPresenter;

/**
 * MVP 的写法，Version 3: 使用软引用 + 动态代理
 *
 * @author 神探丶威威猫
